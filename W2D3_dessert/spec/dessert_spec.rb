...
describe Dessert do
  ...
  let(:chef) { double("chef", name: "Annika") }
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ['flour', 'egg', 'sugar', 'butter', 'milk', 'vanilla']
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Annika the Great Baker")
      expect(cake.serve).to eq("Chef Annika the Great Baker has made 50 cakes!")
    end
  end
